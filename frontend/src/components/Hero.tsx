...
const Hero: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-[radial-gradient(circle_at_center,transparent_0%,var(--color-bg)_70%)] -z-10"></div>

      <div className="max-w-4xl mx-auto px-6 relative z-10 flex flex-col justify-center items-center">
        <h1 className="heading-1 animate-text mb-10">
          Transforming Ideas
          <br />
          <span className="gradient-text">Into Intelligent Products</span>
        </h1>

        <p className="text-lg md:text-xl text-[var(--color-text-muted)] animate-text mb-14 max-w-2xl leading-relaxed">
