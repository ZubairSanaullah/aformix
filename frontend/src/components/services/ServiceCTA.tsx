        ...
        >
          ...
          <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-5 justify-center w-full sm:w-auto">
              <Link to="https://calendly.com/aformixtech/30min" target="_blank" className="w-full sm:w-auto">
                <button
            ...
            {/* Trust signals */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-16 w-full border-t border-slate-200/60 pt-10">
              {[
                ...
                <div key={trust.label} className="flex flex-col items-center gap-3 text-slate-600">
                  <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center text-2xl border border-slate-100 shadow-sm">
                    {trust.icon}
                  </div>
