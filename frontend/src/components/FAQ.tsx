          ...
          {faqs.map((faq, index) => {
            ...
            return (
              <div
                ...
                data-index={index}
                className={`group relative overflow-hidden rounded-xl md:rounded-[2rem] border border-[var(--color-glass-border)] glass-effect shadow-xl transition-all duration-700 ease-out transform-gpu ${
              ...
              >
                ...
                >
                  <span className={`text-base md:text-2xl font-semibold transition-colors flex-1 ${
                    isOpen ? "text-[var(--color-text)]" : "text-[var(--color-text)] group-hover:text-[var(--color-text)]"
                  }`}>
                    {faq.question}
                  </span>
                  <div className={`w-10 h-10 md:w-11 md:h-11 min-w-[2.5rem] min-h-[2.5rem] md:min-w-[2.75rem] md:min-h-[2.75rem] rounded-full flex items-center justify-center transition-all duration-500 flex-shrink-0 ${
